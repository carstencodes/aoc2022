...
def move_head_tail(head, tail, current_move, visited_nodes):
...
for move in movement:
    ...
    if direction == "R":
        moves.append((move, (0, count)))
    elif direction == "L":
        moves.append((move, (0, 0 - count)))
    elif direction == "U":
        moves.append((move, (0 - count, 0)))
    elif direction == "D":
        moves.append((move, (count, 0)))
    else:
        raise ValueError(f"Invalid direction: {direction}")

for next_move in moves:
    print(next_move[0])
    head_ptr, tail_ptr = move_head_tail(head_ptr, tail_ptr, next_move[1], visits)
