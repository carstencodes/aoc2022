...
internal static class Data{
    internal static readonly string Sample = @"Valve AA has flow rate=0; tunnels lead to valves DD, II, BB
...
Valve JJ has flow rate=21; tunnel leads to valve II";
    internal static readonly string Puzzle = @"Valve NQ has flow rate=0; tunnels lead to valves SU, XD
